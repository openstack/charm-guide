...
.. code-block:: none
   ...
   juju integrate <charm-name>-hacluster:ha <charm-name>:ha
...
.. code-block:: none
   ...
   juju integrate keystone:identity-service cinder:identity-service
...
.. code-block:: none
   ...
   juju integrate nova-cloud-controller-hacluster:ha nova-cloud-controller:ha
...
.. code-block:: none
   ...
   juju integrate memcached:cache nova-cloud-controller:memcache
...
.. code-block:: none
   ...
   juju integrate mysql-hacluster:ha mysql:ha
...
.. code-block:: none
   ...
   juju integrate vault:ha vault-hacluster:ha
   juju integrate vault:shared-db percona-cluster:shared-db
   juju integrate etcd:db vault:etcd
   juju integrate etcd:certificates easyrsa:client
