...
Ubuntu 24.04 LTS (Noble) support
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

All 65 stable charms in the 2024.1 (Caracal) release support Ubuntu 24.04 LTS
(Noble) as a deployment series. Noble can be used for new deployments as well as
a target for :doc:`../admin/upgrades/series` upgrades from Jammy.
