...
Arista requires a special PPA
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Because of `LP #1889396`_ the official networking-arista package can't be used.
A bugfix is currently under review. For the time being some unofficial packages
containing this fix have been published to the following PPAs:
...
* https://launchpad.net/~aurelien-lourot/+archive/ubuntu/arista-ussuri

The `Arista test bundles`_ are good examples of how to make use of these PPAs.
...
.. _Arista test bundles: https://github.com/openstack/charm-neutron-api-plugin-arista/tree/master/src/tests/bundles
...
.. _LP #1889396: https://bugs.launchpad.net/networking-arista/+bug/1889396
